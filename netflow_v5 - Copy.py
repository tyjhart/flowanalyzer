		...
		if netflow_version != 5:
			...
			for flow in range(0, flow_count):
				...
				if dns is True:	
					...
					if flow_index["_source"]["IPv4 Source"] == '255.255.255.255':
						pass
					elif lookup_internal is False and source_ip.iptype() == 'PRIVATE':
						pass
					else:
					...
					if flow_index["_source"]["IPv4 Destination"] == '255.255.255.255':
						pass
					elif lookup_internal is False and destination_ip.iptype() == 'PRIVATE':
						pass
					else:	
